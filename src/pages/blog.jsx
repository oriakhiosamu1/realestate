...
const RealEstateBlog = () => {
  ...
  const filteredPosts = selectedCategory === 'All' ? blogPosts : blogPosts.filter(post => post.tags.includes(selectedCategory));
      ...
      <header className="bg-gradient-to-r from-yellow-800 to-yellow-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            ...
            <h1 style={{ color: 'black' }} className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">Real Estate Insights</h1>
          </div>
          <p style={{ color: '#713F12' }} className="text-base sm:text-lg lg:text-xl text-yellow-100 max-w-2xl">
            ...
            {categories.map((category) => (
              <button
                ...
                className={`px-3 sm:px-4 py-1.5 sm:py-2 text-sm sm:text-base rounded-full font-medium whitespace-nowrap transition-all duration-200 ${
                  selectedCategory === category ? 'bg-yellow-800 text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                }`}
              >
                {category}
              </button>
              ...
              <div className="p-4 sm:p-5 lg:p-6">
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-1 text-xs sm:text-sm text-gray-500">
                    ...
                    <span className="truncate">{new Date(post.created_at).toLocaleDateString('en-US', { 
                      month: 'short', 
                      day: 'numeric', 
                      year: 'numeric' 
                    })}</span>
            ...
            <div className="sticky top-0 bg-white border-b px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between z-10 rounded-t-xl sm:rounded-t-2xl">
              <div className="flex items-center gap-2 sm:gap-3">
                <span className="px-2.5 py-1 bg-yellow-800 text-white text-xs font-semibold rounded-full">
                  ...
                  {Array.isArray(selectedPost.tags) ? selectedPost.tags.join(" | ") : selectedPost.tags}
                </span>
              </div>
              <button
                onClick={closeModal}
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 lg:gap-4 mb-4 sm:mb-6 text-xs sm:text-sm text-gray-600 pb-4 sm:pb-6 border-b">
                ...
                <div className="flex items-center gap-1.5 sm:gap-2">
                  ...
                  <span className="truncate">{new Date(selectedPost.created_at).toLocaleDateString('en-US', { 
                    month: 'long', 
                    day: 'numeric', 
                    year: 'numeric' 
                  })}</span>
              ...
              <div className="mt-6 sm:mt-8 pt-6 border-t">
                <div className="bg-yellow-50 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-yellow-100">
                  ...
                  <button onClick={() => navigate("/agents")} className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-yellow-800 text-white rounded-lg hover:bg-yellow-900 transition-colors duration-200 font-medium shadow-md hover:shadow-lg text-sm sm:text-base">
                    Contact an Agent
                  </button>
                </div>
              </div>
